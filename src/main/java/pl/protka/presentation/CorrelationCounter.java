...
public class CorrelationCounter {
    ...
    private static final int TEXT_CITIES = 0;
    private static final int TEXT_COUNTRIES = 0;
    private static final int TEXT_UNIS = 0;
    private static final int BOX_CITIES = 0;
    private static final int BOX_COUNTRIES = 0;
    private static final int BOX_UNIS = 0;
